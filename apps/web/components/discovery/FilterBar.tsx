...
export function FilterBar({
  ...
  React.useEffect(() => {
    ...
    internal.tone,
    internal.niche,
    internal.minFollowers,
    internal.maxFollowers,
    internal.verifiedOnly,
    internal.sort,
  ]);
  ...
  return (
    <div
      className={cn(
        "rounded-2xl border border-white/10 bg-gray-900/80 p-4 backdrop-blur",
        className
      )}
    >
      <div className="grid grid-cols-1 gap-3 md:grid-cols-12">
        ...
        <div className="md:col-span-3">
          <div className="text-xs text-white/60">
            Min followers: {internal.minFollowers.toLocaleString()}
          </div>
          <Slider
            min={0}
            max={1000000}
            ...
            onValueChange={([v]) =>
              setInternal((s) => ({ ...s, minFollowers: v }))
            }
          />
        </div>
        ...
        <div className="md:col-span-3 md:col-start-1">
          <div className="text-xs text-white/60">
            Max followers: {internal.maxFollowers.toLocaleString()}
          </div>
          <Slider
            min={10000}
            max={3000000}
            ...
            onValueChange={([v]) =>
              setInternal((s) => ({ ...s, maxFollowers: v }))
            }
          />
        </div>
        ...
        <div className="flex items-center gap-2 md:col-span-2">
          <Checkbox
            ...
            onCheckedChange={(c) =>
              setInternal((s) => ({ ...s, verifiedOnly: Boolean(c) }))
            }
          />
