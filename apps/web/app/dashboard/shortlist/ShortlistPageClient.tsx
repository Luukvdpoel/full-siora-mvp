...
export default function ShortlistPageClient({ remaining, plan }: { remaining: number; plan: "FREE" | "PRO" }) {
  ...
  const exportCsv = () => {
    ...
    if (!isPro) headers.push("GeneratedWith");
  ...
  return (
    <main className="min-h-screen bg-gradient-radial from-Siora-dark via-Siora-mid to-Siora-light text-white px-6 py-10">
      <div className="max-w-7xl mx-auto space-y-8">
        <LowCreditBanner remaining={remaining} />
